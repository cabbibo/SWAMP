...
var Water = function ( geometry, options ) {
	...
	var mirrorShader = {
		...
		fragmentShader: [
			...
			'	vec2 uv0 = ( uv / 103.0 ) + vec2(time *speed / 17.0, time *speed / 29.0);',
			'	vec2 uv1 = uv / 107.0-vec2( time *speed / -19.0, time *speed / 31.0 );',
			'	vec2 uv2 = uv / vec2( 8907.0, 9803.0 ) + vec2( time *speed / 101.0, time *speed / 97.0 );',
			'	vec2 uv3 = uv / vec2( 1091.0, 1027.0 ) - vec2( time *speed / 109.0, time *speed / -113.0 );',
