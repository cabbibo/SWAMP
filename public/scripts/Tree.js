...
function Tree( params  ){
  ...
  Tree.prototype.createGeo = function( params ){
   ...
   // console.log( totalVerts );
    ...
    geometry.setAttribute( 'position', norA );
    geometry.setAttribute( 'normal', posA );
    geometry.setAttribute( 'uv', uvA );
    ...
    for( var i = size-1; i >= 0; i-- ){
      ...
      if( NO_MORE_FOR_THE_LOVE_OF_GOD === false ){
        ...
        if( rand <  finalChance ){//finalChance ){
          ...
          newDir = v1.multiplyScalar( Math.cos(angle * 6.28));
          newDir.add( v3.multiplyScalar( -Math.sin(angle*6.28)) );
          newDir.normalize();
          newDir.lerp( dif ,this.params.upVsOut);
         ...
         // lightDir.normalize();
          ...
          if( i !== 0 ){
            ...
            newDir.cross( new THREE.Vector3(1,1,1) );
            newDir.normalize();
